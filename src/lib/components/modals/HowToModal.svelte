...
<div class="modal-overlay" transition:fade>
	<div class="modal" transition:scale>
		<button class="close" on:click={() => howToIsOpen.set(false)}> X </button>
		<br />
		<p>
			While in development, you may need to refresh the page if certain actions are not appearing on
			command. This is an ongoing issue and I am working to fix it.
		</p>
		<ul>
			<li>
			...
			<li>Click on an image in the toolbar to add it to your page</li>
			<li>Drag and drop your image to reposition it</li>
